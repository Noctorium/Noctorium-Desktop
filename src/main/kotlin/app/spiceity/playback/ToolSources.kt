...
/**
 * Which published file belongs to this machine, for each program Spiceity fetches.
 *
...
internal fun hostPlatform(
    ...
    val arm = when (osArch.lowercase()) {
        ...
        // build for that Spiceity should be guessing at.
 ...
 * manager already does properly. So Spiceity says the command instead of pretending it can do it.
 */
