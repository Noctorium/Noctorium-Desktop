...
object AppIcon {
    ...
    fun image(size: Int): BufferedImage {
        ...
        try {
            ...
            // and descent leave room for letters this one does not have, and centring on those sits the S
            // visibly high in the square.
            val glyph = g.font.createGlyphVector(g.fontRenderContext, "S")
