...
val SpiceityPanel = Color(0xFF07050A)
val SpiceityPurple = Color(0xFFB47CFF)
val SpiceityPurpleStrong = Color(0xFF8B5CF6)
val SpiceityPurpleDark = Color(0xFF2A1248)
val SpiceityLavender = Color(0xFFD8B4FE)

val SpiceityColors = darkColorScheme(
    primary = SpiceityPurple,
    onPrimary = Color(0xFF16002D),
    primaryContainer = SpiceityPurpleDark,
    onPrimaryContainer = SpiceityLavender,
    secondary = SpiceityLavender,
 ...
 */
fun spiceityColorScheme(accent: Color, background: Color) = darkColorScheme(
    primary = accent,
...
val SpiceityDarkBackground = Color(0xFF0D0B12)
